			...
			<div class="container">
				<div class="row">
					...
					<div class="card col-sm-4 pt-3 bg-light border-warning">
						<h2 class="page-header text-warning text-center font-weight-bold">LOGIN USER</h2> 
						...
						<form action="cek_login.php" method="post">
							<div class="form-group">
								<label class="font-weight-bold text-info">Username</label><br>
								<input type="nomeja" class="form-control" name="username">
								<label class="font-weight-bold text-info">Password</label><br>
								<input type="password" class="form-control" name="password">
								<br>
								<center> <button class="btn btn-primary" name="login" value="login">Login</button> </center>
							</div>	
						</form>
					</div>
					<div class="col-sm-4">
