...
<body>
    ...
    <div class="container">
     ...
     <div class="container">
      <div class="row"> 
       ...
       <div class="col sm-2">
        <div class="card border-light text-right text-light bg-warning">
         <h3 class="text-center font-weight-bold">No. Meja : <?php echo $_SESSION ["meja"] ['no_meja']; ?> </h3>
       </div>
       <div class="col sm-2">
       </div>
     </div>      
    ...
    <div class="row">
     ...
     <div class="col md-4">
      <div class="card border-info bg-info border-light">
       ...
       <h3 class="text-center font-weight-bold text-light">"Snack"</h3>
     </div>
   </div>
   <div class="col md-4">
 ...
 <br>
      <div class="row">
        ...
        <?php $ambil=$koneksi-> query ("SELECT * FROM  menu INNER JOIN kategori ON menu.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'snack' ");  ?>
        <?php while ($perproduk = $ambil->fetch_assoc()){ ?>


          <div class="card bg-light border-info ml-4 mb-3" style="width: 16rem;">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title text-center text-info">Rp. <?php  echo number_format($perproduk ['harga_menu']); ?> </h5>
