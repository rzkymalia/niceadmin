  ...
  <nav class="navbar navbar-expand-lg navbar-light  bg-light fixed-top mb-3">
      ...
      <div class="row">
       ...
       <div class="col md-4">
        <div class="card border-info bg-info border-light">
         ...
         <h3 class="text-center font-weight-bold text-light">"Makanan"</h3>
       </div>
     </div>
     <div class="col md-4">
   ...
   <br>
      ...
      <div class="row">
        ...
        <?php $ambil=$koneksi-> query ("SELECT * FROM  menu INNER JOIN kategori ON menu.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'makanan' ");  ?>
